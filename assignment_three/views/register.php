            ...
            <div class="mx-auto max-w-xl">
                <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    ...
                    <div class="mt-10 mx-auto w-full max-w-xl">
                        <form class="space-y-6" action="../app/controllers/RegisterController.php" method="POST">
                            <div>
                                ...
                                <?php if ($errors['name']) : ?>
                                    <p class="text-xs text-red-600 mt-2"><?php echo $errors['name'] ?></p>
                                <?php endif; ?>
                            ...
                            <div>
                                ...
                                <?php elseif ($registerError['reg_error']) : ?>
                                    <p class="text-xs text-red-600 mt-2"><?php echo $registerError['reg_error'] ?></p>
                                <?php endif; ?>
                            ...
                            <div>
                                ...
                                <?php elseif ($errors['confirm_password']) : ?>
                                    <p class="text-xs text-red-600 mt-2"><?php echo $errors['confirm_password'] ?></p>
                                <?php endif; ?>
                            </div>
