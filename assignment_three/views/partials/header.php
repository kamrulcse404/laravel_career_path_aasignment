    ...
    <header class="bg-white">
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <?php if ($loginSuccess['auth']) : ?>
                    <span class="text-sm font-semibold text-green-600 leading-6 text-gray-900"><?php echo $user_name ?></span>
                    <span>&nbsp;</span>
                    <span>&nbsp;</span>
                    <a href="../app/controllers/LogoutController.php" class="text-sm font-semibold leading-6 text-gray-900">Log Out <span aria-hidden="true">&rarr;</span></a>
                <?php elseif (!$loginSuccess['auth']) : ?>
